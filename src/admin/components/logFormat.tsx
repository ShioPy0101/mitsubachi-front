...
const actionLabels: Record<string, string> = {
  "audit_log.index": "操作履歴を閲覧",
  "audit_log.show": "操作履歴の詳細を閲覧",
  ...
  "drive_item.delete": "ゴミ箱へ移動",
  "drive_item.restore": "ファイルを復元",
  "drive_item.create": "ファイルを作成",
  "drive_item.rename": "名前を変更",
  "drive_item.move": "移動",
  "drive_item.purge": "完全削除",
  "drive_item.download_folder": "フォルダをダウンロード",
  ...
  "external_share.create": "外部共有を作成",
  "external_share.update": "外部共有を更新",
  "external_share.destroy": "外部共有を削除",
  "organization_membership.create": "Organizationメンバーを追加",
  "organization_membership.update": "Organizationメンバーを更新",
  "organization_membership.destroy": "Organizationメンバーを削除",
